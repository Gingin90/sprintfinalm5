...
fun returnShoeList(): List<Item> {
    ...
    val shoeItem3 = Item("Zapato 3", "https://example.com/zapato3.jpg", 149.99)
    shoeList.add(shoeItem3)
    val shoeItem4 = Item("Zapato 4", "https://example.com/zapato4.jpg", 129.99)
    ...
    val shoeItem8 = Item("Zapato 8", "https://example.com/zapato8.jpg", 169.99)
    shoeList.add(shoeItem8)
    val shoeItem9 = Item("Zapato 9", "https://example.com/zapato9.jpg", 119.99)
